	...
	<header>
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="#"><img src="img/ewa.png" alt="Logo"></a>
...
<!--end: Header-->
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2>MIE INSTANT</h2>
				<p>Kami juga menyediakan berbagai makanan mie instans. Cek Di toko kami ya .</p>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/ewarung.png" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2>Kebutuhan Keluarga</h2>
				<p>Kami juga menyediakan berbagai kebutuhan rumah tangga, seperti sabun dll. cek di toko kami sekarang.</p>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/ewarung.png" alt="image02" /></div>
			</div>
			<div class="da-slide">
				<h2>Kebutuhan Dapur</h2>
				<p>kami memiliki kebutuhan yang pas di dapur anda,  berbagai kebutuhan dapur tersedia di sini. Silahkan cek di toko kami ya .</p>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/ewarung.png" alt="image03" /></div>
			</div>
